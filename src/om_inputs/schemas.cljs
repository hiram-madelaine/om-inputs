...
(def sch-popover {(s/optional-key :tooltip-position) (s/enum "right" "bottom" "left" "top")})


(def SchOptions
  (merge {(s/optional-key :IWillReceiveProps)  s/Any
          ...
          s/Keyword                            (merge {(s/optional-key :type)        s/Str
